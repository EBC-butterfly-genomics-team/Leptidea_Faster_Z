...
ggsave(filename = ("dnds_press_1.jpeg"), width = 2.5, height = 5, units = "in", dpi = 600, limitsize = F)
...
all_chr_plot <- ggplot(data=df_filtered, aes(y=dnds, x=chrN, fill=chrN)) +
  ...
  theme(legend.position = "none",
        ...
        axis.ticks.x = element_blank(),
        axis.line.y = element_line(colour = "grey10"),
        axis.title.x = element_text(size=label_sizes),
...
ggsave(filename = ("figure_2.jpeg"), width = 15, height = 10, units = "in", dpi = 600, limitsize = F)
