...
# join m+f...
swe_mf_gene_median <- merge(swe_m_gene_median, swe_f_gene_median, by = c("chr", "gene_id", "gene_midpoint"))

swe_mf_gene_median$mf_ratio <- log2(swe_mf_gene_median$norm_median.x/swe_mf_gene_median$norm_median.y)
...
# join m+f...
dup_mf_gene_median <- merge(dup_m_gene_median, dup_f_gene_median, by = c("chr", "gene_id", "gene_midpoint"))

# calculate per gene log2 m/f ratio...
dup_mf_gene_median$mf_ratio <- log2(dup_mf_gene_median$norm_median.x/dup_mf_gene_median$norm_median.y)
...
# join m+f...
mor_mf_gene_median <- merge(mor_m_gene_median, mor_f_gene_median, by = c("chr", "gene_id", "gene_midpoint"))

# calculate per gene log2 m/f ratio...
mor_mf_gene_median$mf_ratio <- log2(mor_mf_gene_median$norm_median.x/mor_mf_gene_median$norm_median.y)
...
median(swe_m_all_snps$snp_count)
median(swe_m_auto_snps$snp_count)
# calculate normalization due to difference in snp count between samples...
swe_m_Z_snps$snp_count <- swe_m_Z_snps$snp_count/median(swe_m_all_snps$snp_count)

# invert coords to match age for Z1 and Z2...(max-pos)
swe_m_Z1_snps <- swe_m_Z_snps[swe_m_Z_snps$chr == "HiC_scaffold_1", ]
swe_m_Z1_snps$start <- max(swe_m_Z1_snps$start)-swe_m_Z1_snps$start
swe_m_Z1_snps$end <- max(swe_m_Z1_snps$end)-swe_m_Z1_snps$end
swe_m_Z1_snps$mid <- (swe_m_Z1_snps$start+swe_m_Z1_snps$end)/2

swe_m_Z2_snps <- swe_m_Z_snps[swe_m_Z_snps$chr == "HiC_scaffold_6", ]
swe_m_Z2_snps$start <- max(swe_m_Z2_snps$start)-swe_m_Z2_snps$start
swe_m_Z2_snps$end <- max(swe_m_Z2_snps$end)-swe_m_Z2_snps$end
swe_m_Z2_snps$mid <- (swe_m_Z2_snps$start+swe_m_Z2_snps$end)/2

swe_m_Z3_snps <- swe_m_Z_snps[swe_m_Z_snps$chr == "HiC_scaffold_18", ]
swe_m_Z3_snps$mid <- (swe_m_Z3_snps$start+swe_m_Z3_snps$end)/2
...
median(swe_f_all_snps$snp_count)
median(swe_f_auto_snps$snp_count)
...
swe_f_Z1_snps$start <- max(swe_f_Z1_snps$start)-swe_f_Z1_snps$start
swe_f_Z1_snps$end <- max(swe_f_Z1_snps$end)-swe_f_Z1_snps$end
swe_f_Z1_snps$mid <- (swe_f_Z1_snps$start+swe_f_Z1_snps$end)/2

swe_f_Z2_snps <- swe_f_Z_snps[swe_f_Z_snps$chr == "HiC_scaffold_6", ]
swe_f_Z2_snps$start <- max(swe_f_Z2_snps$start)-swe_f_Z2_snps$start
swe_f_Z2_snps$end <- max(swe_f_Z2_snps$end)-swe_f_Z2_snps$end
swe_f_Z2_snps$mid <- (swe_f_Z2_snps$start+swe_f_Z2_snps$end)/2

swe_f_Z3_snps <- swe_f_Z_snps[swe_f_Z_snps$chr == "HiC_scaffold_18", ]
swe_f_Z3_snps$mid <- (swe_f_Z3_snps$start+swe_f_Z3_snps$end)/2
...
swe_m_Z1_snps_plot <- ggplot(swe_m_Z1_snps, aes(x=mid, y=1, fill=trans_method(snp_count/swe_snp_plot_scaling))) +
  ...
  annotate("segment", y=0.5, yend=1.5, x=0, xend=0, size=10000000/Z1_max_coord, color=male_color) +
  annotate("segment", y=0.5, yend=1.5, x=Z1_max_coord, xend=Z1_max_coord, size=10000000/Z1_max_coord, color=male_color)
...
swe_m_Z2_snps_plot <- ggplot(swe_m_Z2_snps, aes(x=mid, y=1, fill=trans_method(snp_count/swe_snp_plot_scaling))) +
  ...
  theme(panel.background = element_rect(fill = "white", color = male_color)) +
  scale_x_continuous(expand = c(0, 0)) +
  annotate("segment", y=0.5, yend=1.5, x=0, xend=0, size=10000000/Z2_max_coord, color=male_color) +
  annotate("segment", y=0.5, yend=1.5, x=Z2_max_coord, xend=Z2_max_coord, size=10000000/Z2_max_coord, color=male_color) 
...
swe_m_Z3_snps_plot <- ggplot(swe_m_Z3_snps, aes(x=mid, y=1, fill=trans_method(snp_count/swe_snp_plot_scaling))) +
  ...
  theme(panel.background = element_rect(fill = "white", color = male_color)) +
  scale_x_continuous(expand = c(0, 0)) +
  annotate("segment", y=0.5, yend=1.5, x=0, xend=0, size=10000000/Z3_max_coord, color=male_color) +
  annotate("segment", y=0.5, yend=1.5, x=Z3_max_coord, xend=Z3_max_coord, size=10000000/Z3_max_coord, color=male_color) 
...
swe_f_Z1_snps_plot <- ggplot(swe_f_Z1_snps, aes(x=mid, y=1, fill=trans_method(snp_count/swe_snp_plot_scaling))) +
  ...
  scale_x_continuous(expand = c(0, 0)) +
  annotate("segment", y=0.5, yend=1.5, x=0, xend=0, size=10000000/Z1_max_coord, color=female_color) +
  annotate("segment", y=0.5, yend=1.5, x=Z1_max_coord, xend=Z1_max_coord, size=10000000/Z1_max_coord, color=female_color)
...
swe_f_Z2_snps_plot <- ggplot(swe_f_Z2_snps, aes(x=mid, y=1, fill=trans_method(snp_count/swe_snp_plot_scaling))) +
  ...
  theme(panel.background = element_rect(fill = "white", color = female_color)) +
  scale_x_continuous(expand = c(0, 0)) +
  annotate("segment", y=0.5, yend=1.5, x=0, xend=0, size=10000000/Z2_max_coord, color=female_color) +
  annotate("segment", y=0.5, yend=1.5, x=Z2_max_coord, xend=Z2_max_coord, size=10000000/Z2_max_coord, color=female_color)
...
swe_f_Z3_snps_plot <- ggplot(swe_f_Z3_snps, aes(x=mid, y=1, fill=trans_method(snp_count/swe_snp_plot_scaling))) +
  ...
  theme(panel.background = element_rect(fill = "white", color = female_color)) +
  scale_x_continuous(expand = c(0, 0)) +
  annotate("segment", y=0.5, yend=1.5, x=0, xend=0, size=10000000/Z3_max_coord, color=female_color) +
  annotate("segment", y=0.5, yend=1.5, x=Z3_max_coord, xend=Z3_max_coord, size=10000000/Z3_max_coord, color=female_color)
...
mor_m_Z1_snps$start <- max(mor_m_Z1_snps$start)-mor_m_Z1_snps$start
mor_m_Z1_snps$end <- max(mor_m_Z1_snps$end)-mor_m_Z1_snps$end
mor_m_Z1_snps$mid <- (mor_m_Z1_snps$start+mor_m_Z1_snps$end)/2

mor_m_Z2_snps <- mor_m_Z_snps[mor_m_Z_snps$chr == "HiC_scaffold_6", ]
mor_m_Z2_snps$start <- max(mor_m_Z2_snps$start)-mor_m_Z2_snps$start
mor_m_Z2_snps$end <- max(mor_m_Z2_snps$end)-mor_m_Z2_snps$end
mor_m_Z2_snps$mid <- (mor_m_Z2_snps$start+mor_m_Z2_snps$end)/2

mor_m_Z3_snps <- mor_m_Z_snps[mor_m_Z_snps$chr == "HiC_scaffold_18", ]
mor_m_Z3_snps$mid <- (mor_m_Z3_snps$start+mor_m_Z3_snps$end)/2
...
mor_f_Z1_snps$start <- max(mor_f_Z1_snps$start)-mor_f_Z1_snps$start
mor_f_Z1_snps$end <- max(mor_f_Z1_snps$end)-mor_f_Z1_snps$end
mor_f_Z1_snps$mid <- (mor_f_Z1_snps$start+mor_f_Z1_snps$end)/2

mor_f_Z2_snps <- mor_f_Z_snps[mor_f_Z_snps$chr == "HiC_scaffold_6", ]
mor_f_Z2_snps$start <- max(mor_f_Z2_snps$start)-mor_f_Z2_snps$start
mor_f_Z2_snps$end <- max(mor_f_Z2_snps$end)-mor_f_Z2_snps$end
mor_f_Z2_snps$mid <- (mor_f_Z2_snps$start+mor_f_Z2_snps$end)/2

mor_f_Z3_snps <- mor_f_Z_snps[mor_f_Z_snps$chr == "HiC_scaffold_18", ]
mor_f_Z3_snps$mid <- (mor_f_Z3_snps$start+mor_f_Z3_snps$end)/2
...
dup_m_Z1_snps$start <- max(dup_m_Z1_snps$start)-dup_m_Z1_snps$start
dup_m_Z1_snps$end <- max(dup_m_Z1_snps$end)-dup_m_Z1_snps$end
dup_m_Z1_snps$mid <- (dup_m_Z1_snps$start+dup_m_Z1_snps$end)/2

dup_m_Z2_snps <- dup_m_Z_snps[dup_m_Z_snps$chr == "HiC_scaffold_6", ]
dup_m_Z2_snps$start <- max(dup_m_Z2_snps$start)-dup_m_Z2_snps$start
dup_m_Z2_snps$end <- max(dup_m_Z2_snps$end)-dup_m_Z2_snps$end
dup_m_Z2_snps$mid <- (dup_m_Z2_snps$start+dup_m_Z2_snps$end)/2

dup_m_Z3_snps <- dup_m_Z_snps[dup_m_Z_snps$chr == "HiC_scaffold_18", ]
dup_m_Z3_snps$mid <- (dup_m_Z3_snps$start+dup_m_Z3_snps$end)/2
...
dup_f_Z1_snps$start <- max(dup_f_Z1_snps$start)-dup_f_Z1_snps$start
dup_f_Z1_snps$end <- max(dup_f_Z1_snps$end)-dup_f_Z1_snps$end
dup_f_Z1_snps$mid <- (dup_f_Z1_snps$start+dup_f_Z1_snps$end)/2

dup_f_Z2_snps <- dup_f_Z_snps[dup_f_Z_snps$chr == "HiC_scaffold_6", ]
dup_f_Z2_snps$start <- max(dup_f_Z2_snps$start)-dup_f_Z2_snps$start
dup_f_Z2_snps$end <- max(dup_f_Z2_snps$end)-dup_f_Z2_snps$end
dup_f_Z2_snps$mid <- (dup_f_Z2_snps$start+dup_f_Z2_snps$end)/2

dup_f_Z3_snps <- dup_f_Z_snps[dup_f_Z_snps$chr == "HiC_scaffold_18", ]
dup_f_Z3_snps$mid <- (dup_f_Z3_snps$start+dup_f_Z3_snps$end)/2
...
anc_Z_start <- Z1_max_coord-10536855
anc_Z_end <- Z1_max_coord-32728189
neo_17_start <- Z1_max_coord-25979
neo_17_end <- Z1_max_coord-10453464
...
neo_11_start <- Z2_max_coord-75688
neo_11_end <- Z2_max_coord-10209824
neo_7_start <- Z2_max_coord-11321879
neo_7_end <- Z2_max_coord-20054014
neo_24_start <- Z2_max_coord-20280782
neo_24_end <- Z2_max_coord-26584900
...
swe_mf_Z1 <- swe_mf_gene_median[swe_mf_gene_median$chr == "HiC_scaffold_1", ]

# invert coordinates...

swe_mf_Z1$gene_midpoint <- Z1_max_coord-(swe_mf_Z1$gene_midpoint)

swe_mf_Z1_plot <- ggplot(swe_mf_Z1, aes(x=gene_midpoint, y=mf_ratio)) +
  geom_point(aes(color = mf_ratio), size=point_size) +
  ...
  scale_x_continuous(labels = unit_format(unit = "mb", scale = 1e-6), expand = c(0, 0),
                     minor_breaks = seq(2500000, 32500000, by=2500000)) +
  scale_y_continuous(breaks = c(-2, -1, 0, 1, 2)) +
  ggtitle("Z1") +
  
  ylab("log2 m/f depth ratio") 
...
swe_mf_Z2 <- swe_mf_gene_median[swe_mf_gene_median$chr == "HiC_scaffold_6", ]

# invert coordinates...

swe_mf_Z2$gene_midpoint <- Z2_max_coord-(swe_mf_Z2$gene_midpoint)

swe_mf_Z2_plot <- ggplot(swe_mf_Z2, aes(x=gene_midpoint, y=mf_ratio)) +
  geom_point(aes(color = mf_ratio), size=point_size) +
  scale_color_gradientn(colors=c(female_color, depth_point_color, male_color), limits=c(-3, 3)) +
  coord_cartesian(ylim = c(-3, 3)) +
  ...
  scale_y_continuous(breaks = c(-2, -1, 0, 1, 2)) +
  ggtitle("Z2") +
#  annotate("segment", y=lower_bound, yend=lower_bound, x=0, xend=Z2_max_coord, size=1, color = "red") 
...
swe_mf_Z3 <- swe_mf_gene_median[swe_mf_gene_median$chr == "HiC_scaffold_18", ]

swe_mf_Z3_plot <- ggplot(swe_mf_Z3, aes(x=gene_midpoint, y=mf_ratio)) +
  geom_point(aes(color = mf_ratio), size=point_size) +
  scale_color_gradientn(colors=c(female_color, depth_point_color, male_color), limits=c(-3, 3)) +
  coord_cartesian(ylim = c(-3, 3)) +
...
mor_mf_Z1 <- mor_mf_gene_median[mor_mf_gene_median$chr == "HiC_scaffold_1", ]

# invert coordinates...

mor_mf_Z1$gene_midpoint <- Z1_max_coord-(mor_mf_Z1$gene_midpoint)

mor_mf_Z1_plot <- ggplot(mor_mf_Z1, aes(x=gene_midpoint, y=mf_ratio)) +
  geom_point(aes(color = mf_ratio), size=point_size) +
  scale_color_gradientn(colors=c(female_color, depth_point_color, male_color), limits=c(-3, 3)) +
...
mor_mf_Z2 <- mor_mf_gene_median[mor_mf_gene_median$chr == "HiC_scaffold_6", ]

# invert coordinates...

mor_mf_Z2$gene_midpoint <- Z2_max_coord-(mor_mf_Z2$gene_midpoint)

mor_mf_Z2_plot <- ggplot(mor_mf_Z2, aes(x=gene_midpoint, y=mf_ratio)) +
  geom_point(aes(color = mf_ratio), size=point_size) +
  scale_color_gradientn(colors=c(female_color, depth_point_color, male_color), limits=c(-3, 3)) +
  coord_cartesian(ylim = c(-3, 3), expand = FALSE) +
...
mor_mf_Z3 <- mor_mf_gene_median[mor_mf_gene_median$chr == "HiC_scaffold_18", ]

mor_mf_Z3_plot <- ggplot(mor_mf_Z3, aes(x=gene_midpoint, y=mf_ratio)) +
  geom_point(aes(color = mf_ratio), size=point_size) +
  scale_color_gradientn(colors=c(female_color, depth_point_color, male_color), limits=c(-3, 3)) +
  coord_cartesian(ylim = c(-3, 3), expand = FALSE) +
  geom_smooth(span = Z3_smooth, color=depth_line_color, method = "loess") + 
...
dup_mf_Z1 <- dup_mf_gene_median[dup_mf_gene_median$chr == "HiC_scaffold_1", ]

# invert coordinates...

dup_mf_Z1$gene_midpoint <- Z1_max_coord-(dup_mf_Z1$gene_midpoint)

dup_mf_Z1_plot <- ggplot(dup_mf_Z1, aes(x=gene_midpoint, y=mf_ratio)) +
  geom_point(aes(color = mf_ratio), size=point_size) +
  scale_color_gradientn(colors=c(female_color, depth_point_color, male_color), limits=c(-3, 3)) +
  coord_cartesian(ylim = c(-3, 3), expand = FALSE) +
  geom_smooth(span = Z1_smooth, color=depth_line_color, method = "loess") + 
...
dup_mf_Z2 <- dup_mf_gene_median[dup_mf_gene_median$chr == "HiC_scaffold_6", ]

# invert coordinates...

dup_mf_Z2$gene_midpoint <- Z2_max_coord-(dup_mf_Z2$gene_midpoint)

dup_mf_Z2_plot <- ggplot(dup_mf_Z2, aes(x=gene_midpoint, y=mf_ratio)) +
  geom_point(aes(color = mf_ratio), size=point_size) +
  scale_color_gradientn(colors=c(female_color, depth_point_color, male_color), limits=c(-3, 3)) +
  coord_cartesian(ylim = c(-3, 3), expand = FALSE) +
  geom_smooth(span = Z2_smooth, color=depth_line_color, method = "loess") + 
...
dup_mf_Z3 <- dup_mf_gene_median[dup_mf_gene_median$chr == "HiC_scaffold_18", ]

dup_mf_Z3_plot <- ggplot(dup_mf_Z3, aes(x=gene_midpoint, y=mf_ratio)) +
  geom_point(aes(color = mf_ratio), size=point_size) +
  scale_color_gradientn(colors=c(female_color, depth_point_color, male_color), limits=c(-3, 3)) +
#  coord_cartesian(ylim = c(-3, 3), expand = FALSE) +
  geom_smooth(span = Z3_smooth, color=depth_line_color, method = "loess") + 
...
tree_plot <- ggplot() +
  theme_void() +
  annotate("segment", y=2.75, yend=2.75, x=-2, xend=0, size=branch_size, color=tree_color) +
  
  annotate("segment", y=1, yend=1, x=0, xend=6, size=branch_size, color=tree_color) +
  
  annotate("segment", y=2, yend=2, x=2, xend=6, size=branch_size, color=tree_color) +
  annotate("segment", y=3, yend=3, x=3, xend=6, size=branch_size, color=tree_color) +
  annotate("segment", y=3, yend=4, x=3, xend=3, size=branch_size, color=tree_color) +
  annotate("segment", y=3.5, yend=3.5, x=2, xend=3, size=branch_size, color=tree_color) +
  annotate("segment", y=2, yend=3.5, x=2, xend=2, size=branch_size, color=tree_color) +
  annotate("segment", y=2.75, yend=2.75, x=1, xend=2, size=branch_size, color=tree_color) +
  annotate("segment", y=2.75, yend=4.25, x=1, xend=1, size=branch_size, color=tree_color) +
  annotate("segment", y=4.25, yend=5.75, x=1, xend=1, size=branch_size, color=omega_color) +
  
  annotate("segment", y=4, yend=4, x=3, xend=6, size=branch_size, color=tree_color) +
  annotate("segment", y=5, yend=5, x=4, xend=6, size=branch_size, color=excluded_color) +
  
  annotate("segment", y=5, yend=6.5, x=4, xend=4, size=branch_size, color=excluded_color) +
  annotate("segment", y=5.75, yend=6.5, x=4, xend=4, size=branch_size, color=omega_color) +
  annotate("segment", y=5.75, yend=5.75, x=1, xend=4, size=branch_size, color=omega_color) +
  
  annotate("segment", y=6, yend=6, x=5, xend=6, size=branch_size, color=excluded_color) +
  annotate("segment", y=7, yend=7, x=5, xend=6, size=branch_size, color=omega_color) +
  annotate("segment", y=6, yend=6.5, x=5, xend=5, size=branch_size, color=excluded_color) +
  annotate("segment", y=6.5, yend=7, x=5, xend=5, size=branch_size, color=omega_color) +
  annotate("segment", y=6.5, yend=6.5, x=4, xend=5, size=branch_size, color=omega_color) +
  
  annotate("segment", y=4.25, yend=4.25, x=0, xend=1, size=branch_size, color=tree_color) +
  annotate("segment", y=1, yend=4.25, x=0, xend=0, size=branch_size, color=tree_color) +
  
  annotate("point", y=1, x=0, color=tree_color, size=node_size) +
  annotate("point", y=4.25, x=0, color=tree_color, size=node_size) +
  annotate("point", y=2.75, x=1, color=tree_color, size=node_size) +
  annotate("point", y=5.75, x=1, color="red", size=node_size) +
  annotate("point", y=2, x=2, color=tree_color, size=node_size) +
  annotate("point", y=3.5, x=2, color=tree_color, size=node_size) +
  annotate("point", y=3, x=3, color=tree_color, size=node_size) +
  annotate("point", y=4, x=3, color=tree_color, size=node_size) +
  annotate("point", y=5, x=4, color=excluded_color, size=node_size) +
  annotate("point", y=6, x=5, color=excluded_color, size=node_size) +
  annotate("point", y=6.5, x=4, color="red", size=node_size) +
  annotate("point", y=7, x=5, color="red", size=node_size) +
  annotate("point", y=6.5, x=5, color="red", size=node_size) +
  annotate("point", y=5.75, x=4, color="red", size=node_size) +
  annotate("point", y=4.25, x=1, color=tree_color, size=node_size) +
  
  
  annotate("label", x=9.5, y=7, label="L. sinapis", fontface= "bold.italic", hjust=0.5, size=species_label_size) +
  annotate("text", x=9.5, y=6, label="L. reali", fontface= "italic", hjust=0.5, size=species_label_size) +
  annotate("text", x=9.5, y=5, label="L. juvernica", fontface= "italic", hjust=0.5, size=species_label_size) +
  annotate("label", x=9.5, y=4, label="L. morsei", fontface= "bold.italic", hjust=0.5, size=species_label_size) +
  annotate("text", x=9.5, y=3, label="L. amurensis", fontface= "italic", hjust=0.5, size=species_label_size) +
  annotate("text", x=9.5, y=2, label="L. lactea", fontface= "italic", hjust=0.5, size=species_label_size) +
  annotate("label", x=9.75, y=1, label="L. duponcheli", fontface= "bold.italic", hjust=0.5, size=species_label_size) +
  
    annotate("text", x=13, y=0.1, label="") +
    annotate("text", x=-2, y=7.9, label="") +
    annotate("text", x=6.2, y=5, label="") +
  
  annotate("text", label="Z2+ ", y=3.5, x=-1.5, size=chr_text_size) +
  annotate("segment", y=3.5, yend=3.5, x=-.75, xend=.75, size=chr_size, color=neo_11_color) +
  annotate("text", label="11", y=3.5, x=0, size=chr_text_size) +
#  annotate("segment", y=2.75, yend=2.75, x=-2, xend=-0.5, size=chr_size, color=neo_17_color) +
##  annotate("text", label="17", y=2.75, x=-1.25, size=chr_text_size) +
  
  
  
  
  annotate("segment", y=5, yend=5, x=-.25, xend=.25, size=chr_size, color=neo_19_color) +
#  annotate("text", label="19", y=5, x=0, size=chr_text_size) +
  annotate("segment", y=5, yend=5, x=.25, xend=.75, size=chr_size, color=neo_15_color) +
#  annotate("text", label="15", y=5, x=.5, size=chr_text_size) +
  annotate("segment", y=5, yend=5, x=.75, xend=1.25, size=chr_size, color=neo_8_color) +
#  annotate("text", label="8", y=5, x=1, size=chr_text_size) +
  annotate("segment", y=5, yend=5, x=1.25, xend=1.75, size=chr_size, color=neo_26_color) +
#  annotate("text", label="26", y=5, x=1.5, size=chr_text_size) +
  annotate("segment", y=5, yend=5, x=1.75, xend=2.25, size=chr_size, color=neo_28_color) +
#  annotate("text", label="28", y=5, x=2, size=chr_text_size) +
  annotate("text", label="Z3", y=5, x=1, size=chr_text_size) 
...
ggsave(filename = ("figure_1.jpeg"), width = 15, height = 7.5, units = "in", dpi = 600, limitsize = F)
