      seqfile = genes_xx_block.paml * sequence data filename
     treefile = lep_tree.txt      * tree structure file name
      outfile = genes_xx_block.out           * main result file name
