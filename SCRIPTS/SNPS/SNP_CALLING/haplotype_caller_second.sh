...
BAM=LsinapisSweM-"$1"-sorted.deduped.bqsr
FASTA=LsinapisSweM.fasta

cp /home/larshook/LarsH/FastZ/Snps/HaplotypeCaller/round2/$BAM.bam $SNIC_TMP
...
cp "$BAM"_HiC_scaffold_"$2".g.vcf.gz /home/larshook/LarsH/FastZ/Snps/HaplotypeCaller/round2
