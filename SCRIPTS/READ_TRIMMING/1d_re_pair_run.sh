...
do 
  ...
  cp /home/larshook/LarsH/FastZ/LEPTIDEA_OUTGROUPS/1c_FastQScreen/P14458_"$i"_L003_R*_001_val_*.tagged_filter.fastq.gz $SNIC_TMP
  ...
  cp *final.fq.gz /home/larshook/LarsH/FastZ/LEPTIDEA_OUTGROUPS/1d_RePaired/
